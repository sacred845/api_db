...
use App\Entity\City as Entity;
use App\Api\V1Bundle\Lists\CityList as ListData;
...
class CityController extends ApiController
{
	public function list(Request $request)
    {
		...
		if ($request->get('uri', null))
			...
			if ($request->get('locations_county_id', null)) {
				$filter['locations_county_id'] = $request->get('locations_county_id', null);
			}
			if ($request->get('locations_county_uri', null)) {
				$filter['locations_county_uri'] = $request->get('locations_county_uri', null);
			}
